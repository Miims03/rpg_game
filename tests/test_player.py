import unittest
from model.classes.player.player import *
...
class TestPlayer(unittest.TestCase):
    ...
    def test_add_item(self):
        self.player.inventory.add_item(self.item1)
        self.assertIn(self.item1.uid, self.player.inventory.get_all_item())
    ...
    def test_attack_player(self):
        dammage_result = self.player2.pv - self.player.attack
        self.player.Attack(self.player2)
        self.assertEqual(dammage_result,self.player2.pv)
